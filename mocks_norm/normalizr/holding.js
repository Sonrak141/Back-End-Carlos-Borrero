...
const ramas = new schema.Entity('ramas', {
...
const normData = normalize(holding, ramas)
print(normData)

console.log('Original', JSON.stringify(holding).length)
console.log('Normalizada', JSON.stringify(normData).length)

let or = JSON.stringify(holding).length;
let norm = JSON.stringify(normData).length;
const porcentaje = (norm * 100)/or
